/** @jsx jsx */
import { React, Immutable, ImmutableObject, DataSourceJson, IMState, FormattedMessage, jsx, getAppStore, UseDataSource } from 'jimu-core'
            ...
            <div className='mt-3' style={{ display: displayStyleContent }}>
              <SettingRow label={<FormattedMessage id='font' defaultMessage='Font' />}>
                <ThemeColorPicker
                  ...
                  value={this.getStyleConfig().fontColor || this.props.theme2.arcgis.widgets.legend.variants?.default?.root?.color || ''} onChange={this.onFontStyleChanged}
                />
              </SettingRow>
              <SettingRow label={<FormattedMessage id='background' defaultMessage='Background' />}>
                ...
                <ThemeColorPicker
                  specificTheme={this.props.theme2} value={this.getStyleConfig().background?.color || this.props.theme2.surfaces[1].bg || ''}
