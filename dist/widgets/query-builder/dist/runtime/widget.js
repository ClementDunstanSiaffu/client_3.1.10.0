...
const SecondConstructor = (props) => {
    ...
    const test = (props) => { };
    console.log(dropdowns, tablesId, "checking both");
                        ...
                        if (f.title === this.state.currentTargetText) {
                            this.state.jimuMapView.view.whenLayerView(f).then((layerView) => {
                                ...
                                results.then((result) => {
                                    ...
                                    this.setState({ otherQueriesValue: Object.assign(Object.assign({}, this.state.otherQueriesValue), { [currentClickedQueryAttribute]: detailThirdQuery }) });
                                });
                            });
                        }
                    });
