...
function AddSetTable(props) {
    ...
    tables, getQuery, univocoSelectHandler, dropDown, isOpenDropD, onChangeCheckBox, openDrop, closeDrop, opened, autOpen, mouseleave, onmouseLeave, dropdownsSet, showDelete, blockId, showBlockDelete } = props;
...
/* harmony import */ var _connector_attribute_table_connector__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../connector/attribute_table_connector */ "./your-extensions/widgets/query-builder/src/connector/attribute_table_connector.ts");
/* harmony import */ var esri_geometry_geometryEngine__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! esri/geometry/geometryEngine */ "esri/geometry/geometryEngine");
/* harmony import */ var _components_AddSetTable__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/AddSetTable */ "./your-extensions/widgets/query-builder/src/runtime/components/AddSetTable.tsx");
...
class Widget extends jimu_core__WEBPACK_IMPORTED_MODULE_0__.React.PureComponent {
        ...
        this.addTwoTable = (ev) => {
            let newblock = this.state.SetBlock.map((el) => {
                if (ev.target.id == el.blockId) {
                    ...
                    return Object.assign(Object.assign({}, el), { tablesSet: [...el.tablesSet, { id: id }], tableCounterSet: this.state.tableCounterSet + 1, dropDownsSet: Object.assign(Object.assign({}, el.dropDownsSet), { [currentId]: false }) });
                }
                return el;
            });
            if (this.state.tables.length > 0) {
                ...
                if (highlightIds.length) {
                    ...
                    if (results.features.length) {
                        ...
                        results.features.forEach((el) => {
                            const newGeometry = esri_geometry_geometryEngine__WEBPACK_IMPORTED_MODULE_13__["default"].buffer(el.geometry, 1, "meters");
                            arrayGeometry.push(newGeometry);
                        });
                        if (arrayGeometry.length) {
                            const unifiedGeomtry = esri_geometry_geometryEngine__WEBPACK_IMPORTED_MODULE_13__["default"].union(arrayGeometry);
    ...
    activeViewChangeHandler(jmv) {
        if (jmv) {
            ...
            this.attributeTableConnector = new _connector_attribute_table_connector__WEBPACK_IMPORTED_MODULE_12__["default"](jmv, this);
                ...
                (0,jimu_core__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "mt-4 container-fluid d-flex justify-content-between flex-column", style: { height: "100%" } },
                    ...
                    (0,jimu_core__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "row", style: { height: "50%", overflowY: "scroll" } },
                        (0,jimu_core__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "col-md-12" },
                            ...
                            (0,jimu_core__WEBPACK_IMPORTED_MODULE_0__.jsx)("br", null),
                            this.state.SetBlock.map((el, index) => (0,jimu_core__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { id: index },
                                el.tablesSet.length < 2 ? (el.tablesSet.length == 1 ? (0,jimu_core__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", null, "Visualizza le feature nel layer corrispondenti alla seguente espressione") : '') : ((0,jimu_core__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { style: { display: 'flex', flexDirection: 'row', marginTop: '20px' } },
                                    ...
                                    (0,jimu_core__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: " " },
                                        (0,jimu_core__WEBPACK_IMPORTED_MODULE_0__.jsx)(jimu_ui__WEBPACK_IMPORTED_MODULE_5__.Button, { id: el.blockId, onClick: this.addTwoTable, className: "", icon: true, type: "secondary" },
