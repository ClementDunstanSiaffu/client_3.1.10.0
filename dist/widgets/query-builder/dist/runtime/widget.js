        ...
        this.addTwoTable = (ev) => {
            let newblock = this.state.SetBlock.map((el) => {
                if (ev.target.id == el.blockId) {
                    ...
                    return Object.assign(Object.assign({}, el), { tablesSet: [...el.tablesSet, { id: id, deleted: false }], tableCounterSet: this.state.tableCounterSet + 1, dropDownsSet: Object.assign(Object.assign({}, el.dropDownsSet), { [currentId]: false }) });
                }
                return el;
            });
            if (this.state.tables.length > 0)
