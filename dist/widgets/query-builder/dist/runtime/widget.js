...
class Widget extends jimu_core__WEBPACK_IMPORTED_MODULE_0__.React.PureComponent {
    constructor(props) {
        ...
        this.querySetConstructor = (query, field) => {
            let currentQuery = query.where;
