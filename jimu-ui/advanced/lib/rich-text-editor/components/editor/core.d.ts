 ...
 */
export declare type RichEditorCoreProps = _RichEditorCoreProps & EditorOptions & EditorProps;
/**
...
export declare const RichEditorCore: import("@emotion/styled").StyledComponent<_RichEditorCoreProps & EditorOptions & EditorProps & React.RefAttributes<HTMLElement>, {}, {}>;
export {};
