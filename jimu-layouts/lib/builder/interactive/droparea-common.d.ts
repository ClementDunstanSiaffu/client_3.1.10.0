...
export interface DropAreaProps {
    ...
    onDragOver?: (draggingItem: LayoutItemConstructorProps, draggingElement: HTMLElement, containerRect: DOMRect, itemRect: DOMRect, clientX: number, clientY: number, speed?: number) => void;
    onDragLeave?: (draggingItem: LayoutItemConstructorProps) => void;
    onDrop?: (draggingItem: LayoutItemConstructorProps, containerRect: DOMRect, itemRect: DOMRect, clientX: number, clientY: number) => void;
}
