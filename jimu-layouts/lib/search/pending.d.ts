 ...
 * @param sizeMode
 */
export declare function getPendingLayoutItemsFromOtherSizeMode(appConfig: IMAppConfig, layout: IMSizeModeLayoutJson, sizeMode: BrowserSizeMode, thisWidgetIds?: any, thisSectionIds?: any, thisScreenGroupIds?: any): LayoutInfo[];
