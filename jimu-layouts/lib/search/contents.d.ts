import { IMAppConfig, IMLayoutJson, LayoutItemType, IMLayoutItemJson, LayoutInfo, BrowserSizeMode, ContainerType, IMSizeModeLayoutJson, LayoutItemJson, ImmutableObject, ContainerInfo } from 'jimu-core';
 ...
 * @param type
 */
export declare function getContentsInLayoutWithRecrusiveLayouts(appConfig: IMAppConfig, layoutId: string, type: LayoutItemType, sizeMode: BrowserSizeMode, withPending?: boolean): string[];
/**
 ...
 * @param widgetId
 */
export declare function getContentContainerInfo(appConfig: IMAppConfig, id: string, type: LayoutItemType, sizeMode: BrowserSizeMode, withPanding?: boolean): ContainerInfo;
/**
