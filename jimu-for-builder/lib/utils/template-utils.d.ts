...
export declare function applyPageTemplateToHeader(appConfig: IMAppConfig, templateJson: Template): Promise<{
    appConfig: IMAppConfig;
}>;
export declare function applyPageTemplateToFooter(appConfig: IMAppConfig, templateJson: Template): Promise<{
    appConfig: IMAppConfig;
}>;
export declare function applyPageTemplateToBody(appConfig: IMAppConfig, pageId: string, templateJson: Template): Promise<{
    appConfig: IMAppConfig;
}>;
export declare function applyTemplateToDialog(appConfig: IMAppConfig, dialogId: string, templateJson: Template): Promise<{
    appConfig: IMAppConfig;
}>;
export {};
